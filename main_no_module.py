...
for n,index in enumerate(lines):
    ...
    photo_review_html = driver.page_source

    try:
        driver.find_element_by_xpath('//*[@id="__next"]/div/div[3]/div[1]/ul/li[2]/button').click()
        sleep(0.3)
    ...
    normal_review_html = driver.page_source

    html = photo_review_html + normal_review_html
    ...
    #product_review_infos 포토 & 동영상 리뷰만 크로링함
